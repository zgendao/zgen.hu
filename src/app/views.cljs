...
(defn app []
  (reagent/create-class
    {:component-did-mount (fn [this] (new Swiper ".swiper-container", (clj->js {:slidesPerView "5" :centeredSlides "false" :spaceBetween "0" :pagination {:el ".swiper-pagination"} :navigation {:nextEl ".swiper-button-next" :prevEl ".swiper-button-prev"} :scrollbar {:el ".swiper-scrollbar"}})))
     :reagent-render
     (fn []
